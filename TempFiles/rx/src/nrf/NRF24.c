...
void csn_high(void){
	HAL_GPIO_WritePin(csn_gpio_port, csn_gpio_pin, (GPIO_PinState)GPIO_PIN_SET);
}

void csn_low(void){
	HAL_GPIO_WritePin(csn_gpio_port, csn_gpio_pin, (GPIO_PinState)GPIO_PIN_RESET);
}

void ce_high(void){
	HAL_GPIO_WritePin(ce_gpio_port, ce_gpio_pin, (GPIO_PinState)GPIO_PIN_SET);
}

void ce_low(void){
	HAL_GPIO_WritePin(ce_gpio_port, ce_gpio_pin, (GPIO_PinState)GPIO_PIN_RESET);
}
